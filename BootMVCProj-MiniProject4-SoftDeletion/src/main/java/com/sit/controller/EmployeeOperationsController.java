...
public class EmployeeOperationsController {
	...
	public String deleteEmployeeDetails(@RequestParam("no")int no,
	   ...
	   @PostMapping("/search")
	    public String searchEmployees(@ModelAttribute("emp") Employee e, Map<String,Object> m) {
	        ...
	        m.put("empList", empList);
	        
	        // Optional: Add a message to show search results
	        if (empList.isEmpty()) {
	            m.put("resultMsg", "No records found.");
	        } else {
	        	m.put("resultMsg", "Search results");
	        }
